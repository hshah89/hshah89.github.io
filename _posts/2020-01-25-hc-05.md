...
In the event you encounter an error when sending an AT command, refer to the image below.

<img src="{{ "/images/hc_05/hc-05_at_commands.png" | prepend: site.baseurl }}" width="500px" align="middle">
